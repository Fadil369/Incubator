...
exports.SAUDI_REGIONS_EN = exports.SAUDI_REGIONS_AR = void 0;
exports.validateCRNumber = validateCRNumber;
exports.validateVATNumber = validateVATNumber;
exports.validateSaudiPostalCode = validateSaudiPostalCode;
exports.validateSaudiMobile = validateSaudiMobile;
exports.validateSaudiAddress = validateSaudiAddress;
exports.validateSaudiID = validateSaudiID;
exports.formatSaudiMobile = formatSaudiMobile;
exports.formatCRNumber = formatCRNumber;
exports.formatVATNumber = formatVATNumber;
/**
 ...
 */
function validateSaudiPostalCode(postalCode) {
 ...
 */
function validateSaudiMobile(mobile) {
    if (!mobile)
        return false;
 ...
 */
function validateSaudiAddress(address) {
    const errors = [];
 ...
 */
function validateSaudiID(idNumber) {
 ...
 */
function formatSaudiMobile(mobile) {
    const cleanMobile = mobile.replace(/\D/g, '');
    if (cleanMobile.startsWith('966')) {
        const localNumber = cleanMobile.substring(3);
...
exports.default = {
    ...
    formatCRNumber,
    formatVATNumber,
    SAUDI_REGIONS_AR: exports.SAUDI_REGIONS_AR,
    SAUDI_REGIONS_EN: exports.SAUDI_REGIONS_EN
};
