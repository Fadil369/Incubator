...
import { generateFeasibilityStudy, generateBusinessPlan, generateCertificate, getUserDocuments, downloadDocument, deleteDocument, getDocumentTemplates, } from '../controllers/documentController';
const router = Router();
// Validation schemas
