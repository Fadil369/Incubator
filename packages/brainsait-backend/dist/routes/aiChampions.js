...
const mentorshipApplyLimiter = (0, express_rate_limit_1.default)({
...
router.post('/mentorship/apply', mentorshipApplyLimiter, auth_1.authenticate, (0, validation_1.validateRequest)(MentorshipApplicationSchema), async (req, res) => {
    try {
