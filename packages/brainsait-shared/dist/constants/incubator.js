...
exports.sharedCourseContracts = exports.incubatorCourses = exports.graduationShowcase = exports.incubatorEmailAutomations = exports.incubatorChatMessages = exports.incubatorChatRooms = exports.incubatorMentors = exports.incubatorWorkshops = exports.incubatorResources = exports.incubatorApps = exports.incubatorAppCategories = exports.incubatorRouteCards = void 0;
exports.getIncubatorAppBySlug = getIncubatorAppBySlug;
exports.getIncubatorAppsByCategory = getIncubatorAppsByCategory;
exports.getIncubatorCategoryBySlug = getIncubatorCategoryBySlug;
exports.getFeaturedResources = getFeaturedResources;
exports.getCourseBundleBySlug = getCourseBundleBySlug;
const training_1 = require("./training");
exports.incubatorRouteCards = [
    {
...
exports.incubatorAppCategories = [
    {
        slug: 'healthcare',
...
exports.incubatorMentors = [
    {
        ...
        avatarUrl: training_1.featuredTrainingCourse.instructor.avatarUrl,
    },
    {
        id: 'mentor-lina',
        name: 'Lina Hassan',
...
exports.incubatorEmailAutomations = [
    {
...
exports.incubatorCourses = [
    {
        ...training_1.featuredTrainingCourse,
...
function getIncubatorAppBySlug(slug) {
    return exports.incubatorApps.find((app) => app.slug === slug);
}
function getIncubatorAppsByCategory(category) {
    return exports.incubatorApps.filter((app) => app.category === category);
}
function getIncubatorCategoryBySlug(slug) {
    return exports.incubatorAppCategories.find((category) => category.slug === slug);
}
function getFeaturedResources() {
    return exports.incubatorResources.filter((resource) => resource.featured);
}
function getCourseBundleBySlug(slug) {
    return exports.incubatorCourses.find((course) => course.slug === slug);
}
