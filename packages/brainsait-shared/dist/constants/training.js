...
exports.featuredTrainingCourse = exports.trainingCourses = void 0;
exports.getTrainingCourseBySlug = getTrainingCourseBySlug;
exports.trainingCourses = [
    {
...
exports.featuredTrainingCourse = exports.trainingCourses[0];
function getTrainingCourseBySlug(slug) {
    return exports.trainingCourses.find((course) => course.slug === slug);
}
