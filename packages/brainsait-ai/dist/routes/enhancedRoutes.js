...
router.post('/forecast', async (req, res) => {
    try {
        ...
        const forecast = await financialService.generateFinancialForecast(historicalData, businessPlan, timeframe);
        res.json({
            success: true,
            data: forecast,
        });
...
router.post('/incidents', async (req, res) => {
    try {
        ...
        const incident = await securityService.createSecurityIncident(type, severity, description, affectedResources);
        res.json({
            success: true,
            data: incident,
        });
...
router.get('/report/:organizationId', async (req, res) => {
    try {
        ...
        const report = await securityService.generateSecurityReport(organizationId, new Date(startDate), new Date(endDate));
        res.json({
            success: true,
            data: report,
        });
...
//# sourceMappingURL=enhancedRoutes.js.map