...
class FinancialIntelligenceService {
     ...
     */
    async generateFinancialForecast(historicalData, businessPlan, timeframe = '12m') {
        try {
     ...
     */
    async calculateFinancialHealth(financialData) {
        try {
            const prompt = `
    ...
    parseInvestmentReadinessResponse(response) {
    ...
    parseFundingOpportunities(response) {
        return [
            {
                id: '1',
    ...
    parseFinancialForecast(response, timeframe) {
    ...
    parseValuationGuidance(response) {
        return {
            estimatedValuation: {
                low: 8000000,
                mid: 12000000,
    ...
    parseFinancialHealthScore(response) {
        return {
            overall: 72,
            liquidity: 75,
            profitability: 68,
...
//# sourceMappingURL=financialIntelligenceService.js.map